locals {
  ...
  vnet_rg     = var.env == "demo" || var.env == "preview" || var.env == "ithc" || var.env == "perftest" ? "hmcts-hub-nonprodi" : (var.env == "aat") ? "hmcts-hub-prod-int" : "hmcts-hub-${var.env}-int"
  vnet_name   = var.env == "demo" || var.env == "preview" || var.env == "ithc" || var.env == "perftest" ? "hmcts-hub-nonprodi" : (var.env == "aat") ? "hmcts-hub-prod-int" : "hmcts-hub-${var.env}-int"
  subnet_name = "hub-appgw"
  hub_env     = (var.env == "demo" || var.env == "preview" || var.env == "ithc" || var.env == "perftest") ? "nonprod" : (var.env == "aat") ? "prod" : var.env
